...
const TeamMember = () => {
    return (
        <div id='Team' className=" bg-pink-50 max-w   ">
            <h1 className="font-bold text-center text-4xl py-32 ">Team-Members</h1>
{/* team member start */}
...
<div className="card lg:w-96 hover:shadow-lg hover:shadow-red-500/50 p-0 bg-base-200  rounded-md hover:scale-90 duration-500">
  ...
  <div className="card-body">
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem, qui.</p>
    <div className="card-actions justify-end">
        {/* teammember3 social logo  */}
    <div className="flex gap-4 mt-5 ">
                            <a target="blank" href=" https://github.com/salmaakter11 ">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
